...
bseu@meta.data <- bseu@meta.data[, !grepl("^Leiden*", colnames(bseu@meta.data))]
...
bseu <- FindClusters(bseu,resolution = 0.5,cluster.name = 'Leiden_res.0.5')
