...
sseu$cc_condition <- sseu$A25_M12_M1
cseu <- merge(sseu,C19)
cseu <- JoinLayers(cseu)

unique(cseu$cc_condition)
cseu$cc_condition <- factor(cseu$cc_condition,levels = c("Mod 12 Active","Mod 1 Active","Inactive","DEN FB","Tumour FB"))
```
